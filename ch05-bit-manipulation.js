...
/************************************************************************
  ...
  Given a real number between O and 1 (e.g., 0.72) that is passed in as
...
/************************************************************************
  ...
  eight consecutive pixels to be stored in one byte. The screen has width
  w, where w is divisible by 8 (that is, no byte will be split across
  rows). The height of the screen, of course, can be derived from the
  length of the array and the width. Implement a function that draws a
  horizontal line from ( xl, y) to ( x2, y).
